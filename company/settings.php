            ...
            <div class="row">
              <div class="col-md-6">
                <form id="changePassword" action="change-password.php" method="post">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-warning btn-lg">Change Password</button>
                  </div>
              ...
              <div class="col-md-6">
                <form action="update-name.php" method="post">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-dark btn-lg">Change Name</button>
                  </div>
                </form>
              </div>              
            </div>
