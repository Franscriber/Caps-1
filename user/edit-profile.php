            ...
            ?>
              <div class="row">
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-warning">Update Profile</button>
                  </div>
                </div>
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="stream">Course</label>
                    <input type="text" class="form-control input-lg" id="stream" name="stream" placeholder="Course" value="<?php echo $row['stream']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Skills</label>
