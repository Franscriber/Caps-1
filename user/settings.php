            ...
            <div class="row">
              <div class="col-md-6">
                <form id="changePassword" action="change-password.php" method="post">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-warning">Change Password</button>
                  </div>
              ...
              <div class="col-md-6">
                <form action="deactivate-account.php" method="post">
                  ...
                  <button type="submit" class="btn btn-dark btn-flat btn-lg">Deactivate My Account</button>
                </form>
              </div>
            </div>
